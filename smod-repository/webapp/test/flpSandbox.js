		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SMOD-Repository",
									"targetURL": "#comsmodsmodrepository-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsmodsmodrepository-display": {
								"semanticObject": "comsmodsmodrepository",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.smod.smodrepository",
									"url": sap.ui.require.toUrl("com/smod/smodrepository")
								}
							}
						}
					}
